...
1. **[Core Concepts](./concepts)** — Understanding React, routing, components, and TypeScript
2. **[Goals](./goals)** — What "done" looks like for this slice
3. **Step-by-Step Guide:**
   - [Step 1: Understanding Routing](./steps/01-understanding-routing) — Learn what routing is and why SPAs need it
...
4. **[Verification Checklist](./verification)** — Final comprehensive checklist before moving to Slice 2
...
[Begin Step 1: Understanding Routing →](./steps/01-understanding-routing)
...
**Ready to build?** → [Step 1: Understanding Routing](./steps/01-understanding-routing)
